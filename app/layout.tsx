...
import './globals.css'
import { ClientsStrip, SiteFooter } from '@/components/site-chrome'
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className={`bg-background ${displayFont.variable}`}><body>{children}<ClientsStrip /><SiteFooter />{process.env.NODE_ENV === 'production' && <Analytics />}</body></html>
}
