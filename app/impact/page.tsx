...
export default function ImpactPage() {
  return (
    <main className="impact-page bg-white pb-24">
      <section className="about-intro" style={{ backgroundImage: `linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.8) 100%), url('/projects/seychelles.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center 100%' }}>
